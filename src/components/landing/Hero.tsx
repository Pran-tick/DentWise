...
function Hero() {
  return (
    <section className="relative h-screen flex items-center overflow-hidden pt-20">
      ...
      {/* GRADIENT ORBS */}
      <div className="animate-pulse absolute top-20 left-1/4 w-72 h-72 bg-gradient-to-r from-primary/20 to-primary/10 rounded-full blur-3xl" />
      <div className="animate-pulse absolute bottom-20 right-1/4 w-96 h-96 bg-gradient-to-r from-primary/15 to-primary/5 rounded-full blur-3xl" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                {/* MAIN HEADING */}
                <h1 className="text-xl md:text-6xl lg:text-7xl font-bold tracking-tight">
