    ...
    <section className="relative py-32 px-6 overflow-hidden bg-gradient-to-b from-background to-muted/20">
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hidden lg:block">
            <div className="flex items-center justify-center h-full">
              <Image
                ...
                width={500}
                height={500}
                className="w-full h-auto max-w-lg object-contain hidden lg:block"
              />
            </div>
          </div>
        </div>
